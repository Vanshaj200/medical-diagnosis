    ...
    <Box bg="gray.900" minH="100vh">
      ...
      <Flex direction="row" bg="gray.900" borderTop="1px" borderColor="gray.700">
        <Box
          ...
          height="90vh"
        >
          <Text color={'white'} fontSize={'20px'} fontWeight={'700'}>{isAdmin ? "Admin" : userProfileData}</Text>
          <VStack align="start" spacing="2">
            <List spacing={1}>
              <ListItem>
                <Link to="home">
                  <Button variant="link" color="white" padding="4px" _hover={{ bg: "gray.700" }}>
                    Home
                  </Button>
                </Link>
              </ListItem>
        ...
        <Box flex="1" p="4" maxH="90vh" overflowY="scroll">
          <Routes>
            <Route path="inbox" element={<Applicants />} />
